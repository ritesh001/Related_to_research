...
precision_score, auc, plot_confusion_matrix, matthews_corrcoef, precision_recall_curve, average_precision_score
import sys
...
colors = ['navy', 'turquoise', 'darkorange', 'cornflowerblue', 'teal', 'red', 'lime', 'green', 'blue']
...
plt.legend(loc='best')
#plt.show()
plt.savefig('roc_auc_mcc_cls.eps', dpi=300)
###----------------------------------------------------------------------------
