...
# -*- coding: utf-8 -*-
"""
Created on Tue Dec  1 14:16:48 2020

@author_original: Andrew S. Rosen
@author_edited: ritesh
@link: https://github.com/arosen93/ptable_trends
"""
...
import argparse
from bokeh.io import export, export_svgs
...
parser.add_argument('--cmap_choice',type=str,default='bwr',
	help='Color palette choice: 0 = Plasma, 1 = Inferno, 2 = Magma, 3 = Viridis')
...
cmap = cmap_choice
bokeh_palette = cmap_choice + str(256)
# bokeh_palette = cmap_choice
...
# blank_color = '#c4c4c4'
blank_color = '#C0C0C0'                                                            # edited by me
color_list = []
count_list=[]
...
# =============================================================================
# For ellipse fill_color is not working
# =============================================================================
# p.ellipse('group', 'period', 0.9, 0.9, source=source,
        # fill_alpha=alpha, fill_color='type_color', line_color='black')
# -----------------------------------------------------------------------------

# =============================================================================
# Circle is working; added by me
# =============================================================================
p.circle('group', 'period', size=50, source=source,
        fill_alpha=alpha, fill_color='type_color', line_color='black', line_width=1.0)
# -----------------------------------------------------------------------------
...
# p.text(x=x, y=y, text='atomic_number',
       # text_font_size='11pt', **text_props)                                 # commented by me, as atomic number not needed for me
...
show(p)
export_svgs(p, filename='hard_anion-2.svg')